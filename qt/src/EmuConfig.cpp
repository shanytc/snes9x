...
void EmuConfig::config(const std::string &filename, bool write)
{
    ...
    Int("GBBootPolicy", gb_boot_policy, "Console for GB content, chosen in Emulation -> Game Boy Model: 0=GB, 1=GBC, 2=SGB, 3=SGB+GBC, 4=SGB2, 5=auto prefer GB, 6=auto prefer GBC, 7=auto prefer SGB (default), 8=SGB2+GBC");
    EndSection();
