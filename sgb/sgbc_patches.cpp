...
namespace SGB {
	...
	namespace {
		...
		// 435-byte in memory patch, enabling SGBC.
		const unsigned char kSgbcBiosIps[] = {
			,
		};
		const size_t kSgbcBiosIpsSize = 435;

		// Super Game Boy Color: per-game cart edits, applied to the cart image in memory.
		const CartPatch kSgbcCartPatches[] = {
			// nop_early_ret
			...
			{ 0xDFDB, "SHANGHAI POCKET\200", "Shanghai Pocket (USA) (Rev 1) (Proto)", 0, {},
			  SGBC_QUIRK_HOLD_PAYLOAD },
			// manual: force the SGB detect so the cart sends its borders - one per
			// lake - and stop the SGB flag beating the Color branch at the three gates
			// that pick a palette, or the Color palettes stay flat and every later
			// screen blanks.
			{ 0xC16E, "BASS POCKET 3", "Super Black Bass Pocket 3 (Japan)", 5,
			  { { 0x0002DE, 2, { 0x20, 0x07 }, { 0x00, 0x00 } },
				{ 0x0002E2, 2, { 0x20, 0x03 }, { 0x00, 0x00 } },
				{ 0x00174D, 2, { 0x20, 0x0D }, { 0x00, 0x00 } },
				{ 0x0017F6, 2, { 0x20, 0x0D }, { 0x00, 0x00 } },
			...
			// that pick a palette, or the Color palettes stay flat and every later
			// screen blanks.
			{ 0xDDE6, "TNN FISHINGAFCE\200", "TNN Outdoors Fishing Champ (USA)", 5,
			  { { 0x0002DE, 2, { 0x20, 0x07 }, { 0x00, 0x00 } },
				{ 0x0002E2, 2, { 0x20, 0x03 }, { 0x00, 0x00 } },
				{ 0x001745, 2, { 0x20, 0x0D }, { 0x00, 0x00 } },
				{ 0x0017EE, 2, { 0x20, 0x0D }, { 0x00, 0x00 } },
				{ 0x001B4F, 2, { 0x20, 0x35 }, { 0x00, 0x00 } } },
			  SGBC_QUIRK_STATIC_UNMASK },
			// manual: an SGB detect suppresses the Color flag; stop it
			...
			// display quirk only: blanks its intro transfers and redraws through BGP,
			// which the Color path ignores, so the payload showed on the pane
			{ 0x9813, "YUGIOUDM2\000\000AYKJ\200", "Yu-Gi-Oh! Duel Monsters II - Dark Duel Stories (Japan)", 0, {},
			  SGBC_QUIRK_BGP_OBJ_BLANK },
			// nop_early_ret
		...
		// Super Game Boy compatibility: the cart's own SGB path stops under a BIOS the
		// game never handled. Same row shape, applied under any SGB BIOS.
		const CartPatch kSgbCartPatches[] = {
	...
	static const CartPatch *FindIn(const CartPatch *table, size_t count, const uint8_t *rom, size_t size)
	{
	...
	{
		return FindIn(kSgbcCartPatches, sizeof kSgbcCartPatches / sizeof kSgbcCartPatches[0], rom, size);
	}

	const CartPatch *FindSgbCartPatch(const uint8_t *rom, size_t size)
	{
		return FindIn(kSgbCartPatches, sizeof kSgbCartPatches / sizeof kSgbCartPatches[0], rom, size);
	}
