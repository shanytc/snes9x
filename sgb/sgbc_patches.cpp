...
// DX Monopoly GB (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k027Old0[] = { 0x20, 0x4B };
const uint8_t k027New0[] = { 0x00, 0x00 };
const uint8_t k027Old1[] = { 0xC0 };
const uint8_t k027New1[] = { 0x00 };
const SgbcEdit k027[] = { { 0x0004AA, 2, k027Old0, k027New0 }, { 0x0037C2, 1, k027Old1, k027New1 } };
// EuroSport Pro Champ Fishing (Europe) (Proto) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k028Old0[] = { 0x20, 0x07 };
const uint8_t k028New0[] = { 0x00, 0x00 };
const uint8_t k028Old1[] = { 0x20, 0x03 };
const uint8_t k028New1[] = { 0x00, 0x00 };
const SgbcEdit k028[] = { { 0x0002DE, 2, k028Old0, k028New0 }, { 0x0002E2, 2, k028Old1, k028New1 } };
// Fairy Kitty no Kaiun Jiten - Yousei no Kuni no Uranai Shugyou (Japan) (Rev 1) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret+imm_pre_fork, ref=1 fixed=0)
const uint8_t k029Old0[] = { 0xC8 };
const uint8_t k029New0[] = { 0x00 };
const uint8_t k029Old1[] = { 0x3E, 0xFF };
const uint8_t k029New1[] = { 0x3E, 0x0A };
const SgbcEdit k029[] = { { 0x0380FD, 1, k029Old0, k029New0 }, { 0x038103, 2, k029Old1, k029New1 } };
// Fairy Kitty no Kaiun Jiten - Yousei no Kuni no Uranai Shugyou (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret+imm_pre_fork, ref=1 fixed=0)
const uint8_t k030Old0[] = { 0xC8 };
const uint8_t k030New0[] = { 0x00 };
const uint8_t k030Old1[] = { 0x3E, 0xFF };
const uint8_t k030New1[] = { 0x3E, 0x0A };
const SgbcEdit k030[] = { { 0x0380FD, 1, k030Old0, k030New0 }, { 0x038103, 2, k030Old1, k030New1 } };
// FIFA 2000 (USA, Europe) (SGB Enhanced) (GB Compatible).zip  (force_jr+nop_store, ref=1 fixed=1)
const uint8_t k031Old0[] = { 0x20, 0x27 };
const uint8_t k031New0[] = { 0x18, 0x27 };
const uint8_t k031Old1[] = { 0xE0, 0x9E };
const uint8_t k031New1[] = { 0x00, 0x00 };
const SgbcEdit k031[] = { { 0x000349, 2, k031Old0, k031New0 }, { 0x000384, 2, k031Old1, k031New1 } };
// Hamster Paradise (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch+nop_store, ref=1 fixed=0)
const uint8_t k032Old0[] = { 0x28, 0x13 };
const uint8_t k032New0[] = { 0x00, 0x00 };
const uint8_t k032Old1[] = { 0x28, 0x0D };
const uint8_t k032New1[] = { 0x00, 0x00 };
const uint8_t k032Old2[] = { 0xE0, 0x80 };
const uint8_t k032New2[] = { 0x00, 0x00 };
const SgbcEdit k032[] = { { 0x0015CD, 2, k032Old0, k032New0 }, { 0x0015D3, 2, k032Old1, k032New1 }, { 0x0015DF, 2, k032Old2, k032New2 } };
// Hanasaka Tenshi Tenten-kun no Beat Breaker (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k033Old0[] = { 0xCA, 0x8D, 0x02 };
const uint8_t k033New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k033[] = { { 0x0001A9, 3, k033Old0, k033New0 } };
// Harvest Moon 2 GBC (Europe) (SGB Enhanced) (GB Compatible).zip  (force_jr, ref=0 fixed=0)
const uint8_t k034Old0[] = { 0x28, 0x39 };
const uint8_t k034New0[] = { 0x18, 0x39 };
const SgbcEdit k034[] = { { 0x0001B1, 2, k034Old0, k034New0 } };
// Harvest Moon 2 GBC (Germany) (SGB Enhanced) (GB Compatible).zip  (force_jr, ref=0 fixed=0)
const uint8_t k035Old0[] = { 0x28, 0x39 };
const uint8_t k035New0[] = { 0x18, 0x39 };
const SgbcEdit k035[] = { { 0x0001B1, 2, k035Old0, k035New0 } };
// Harvest Moon 2 GBC (USA) (SGB Enhanced) (GB Compatible).zip  (force_jr, ref=0 fixed=0)
const uint8_t k036Old0[] = { 0x28, 0x39 };
const uint8_t k036New0[] = { 0x18, 0x39 };
const SgbcEdit k036[] = { { 0x0001B1, 2, k036Old0, k036New0 } };
// Honkaku Yonin Uchi Mahjong - Mahjong Ou (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k037Old0[] = { 0xC2, 0xD8, 0x03 };
const uint8_t k037New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k037[] = { { 0x0003CD, 3, k037Old0, k037New0 } };
// Hyper Olympic Series - Track & Field GB (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k038Old0[] = { 0xCA, 0xD1, 0x01 };
const uint8_t k038New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k038[] = { { 0x0001C8, 3, k038Old0, k038New0 } };
// International Rally (USA) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch+imm_pre_fork, ref=1 fixed=1)
const uint8_t k039Old0[] = { 0xCA, 0xE3, 0x01 };
const uint8_t k039New0[] = { 0x00, 0x00, 0x00 };
const uint8_t k039Old1[] = { 0x3E, 0x01 };
const uint8_t k039New1[] = { 0x3E, 0x03 };
const SgbcEdit k039[] = { { 0x0001D5, 3, k039Old0, k039New0 }, { 0x0012EC, 2, k039Old1, k039New1 } };
// International Track & Field (Europe) (En,Fr,De,It) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k040Old0[] = { 0xCA, 0xD1, 0x01 };
const uint8_t k040New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k040[] = { { 0x0001C8, 3, k040Old0, k040New0 } };
// International Track & Field (USA) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k041Old0[] = { 0xCA, 0xD1, 0x01 };
const uint8_t k041New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k041[] = { { 0x0001C8, 3, k041Old0, k041New0 } };
// It's a World Rally (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k042Old0[] = { 0xCA, 0xDD, 0x01 };
const uint8_t k042New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k042[] = { { 0x0001D2, 3, k042Old0, k042New0 } };
// Jinsei Game - Tomodachi Takusan Tsukurou yo! (Japan) (SGB Enhanced) (GB Compatible).zip  (retarget_jr_to_sgb_entry, ref=1 fixed=1)
const uint8_t k043Old0[] = { 0x18, 0x4A };
const uint8_t k043New0[] = { 0x18, 0x00 };
const SgbcEdit k043[] = { { 0x002F0E, 2, k043Old0, k043New0 } };
...
const uint8_t k044Old0[] = { 0xCB, 0x4E };
const uint8_t k044New0[] = { 0xAF, 0x00 };
const SgbcEdit k044[] = { { 0x00025B, 2, k044Old0, k044New0 } };
// Koushien Pocket (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k045Old0[] = { 0xCA, 0x79, 0x02 };
const uint8_t k045New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k045[] = { { 0x00019E, 3, k045Old0, k045New0 } };
...
const uint8_t k056Old0[] = { 0xC0 };
const uint8_t k056New0[] = { 0x00 };
const SgbcEdit k056[] = { { 0x0F2A25, 1, k056Old0, k056New0 } };
...
const uint8_t k057Old0[] = { 0xC0 };
const uint8_t k057New0[] = { 0x00 };
const SgbcEdit k057[] = { { 0x0F2A25, 1, k057Old0, k057New0 } };
...
const uint8_t k058Old0[] = { 0xC0 };
const uint8_t k058New0[] = { 0x00 };
const SgbcEdit k058[] = { { 0x0F2A25, 1, k058Old0, k058New0 } };
...
const uint8_t k059Old0[] = { 0xC0 };
const uint8_t k059New0[] = { 0x00 };
const SgbcEdit k059[] = { { 0x0F2A25, 1, k059Old0, k059New0 } };
...
const uint8_t k060Old0[] = { 0xC0 };
const uint8_t k060New0[] = { 0x00 };
const SgbcEdit k060[] = { { 0x0F2A25, 1, k060Old0, k060New0 } };
// Legend of Zelda, The - Link's Awakening DX (USA, Europe) (Rev 2) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k061Old0[] = { 0xC0 };
const uint8_t k061New0[] = { 0x00 };
const SgbcEdit k061[] = { { 0x0F2A25, 1, k061Old0, k061New0 } };
...
const SgbcEdit k062[] = { { 0x0F2A25, 1, k062Old0, k062New0 } };
// Lodoss-tou Senki - Eiyuu Kishiden GB (Japan) (SGB Enhanced) (GB Compatible).zip  (force_jr, ref=1 fixed=1)
const uint8_t k063Old0[] = { 0x28, 0x39 };
const uint8_t k063New0[] = { 0x18, 0x39 };
const SgbcEdit k063[] = { { 0x00019B, 2, k063Old0, k063New0 } };
// Luca no Puzzle de Daibouken! (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch+nop_store, ref=1 fixed=0)
const uint8_t k064Old0[] = { 0x28, 0x13 };
const uint8_t k064New0[] = { 0x00, 0x00 };
const uint8_t k064Old1[] = { 0x28, 0x0D };
const uint8_t k064New1[] = { 0x00, 0x00 };
const uint8_t k064Old2[] = { 0xE0, 0x80 };
const uint8_t k064New2[] = { 0x00, 0x00 };
const SgbcEdit k064[] = { { 0x000F6D, 2, k064Old0, k064New0 }, { 0x000F73, 2, k064Old1, k064New1 }, { 0x000F7F, 2, k064Old2, k064New2 } };
// Mahjong Joou (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k065Old0[] = { 0xC8 };
const uint8_t k065New0[] = { 0x00 };
const uint8_t k065Old1[] = { 0xC2, 0xD3, 0x0B };
const uint8_t k065New1[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k065[] = { { 0x001097, 1, k065Old0, k065New0 }, { 0x000BB9, 3, k065Old1, k065New1 } };
// Men in Black - The Series (USA, Europe) (SGB Enhanced) (GB Compatible).zip  (force_jr, ref=1 fixed=1)
const uint8_t k066Old0[] = { 0x20, 0x4C };
const uint8_t k066New0[] = { 0x18, 0x4C };
const SgbcEdit k066[] = { { 0x00026B, 2, k066Old0, k066New0 } };
// NHL 2000 (USA, Europe) (SGB Enhanced) (GB Compatible).zip  (force_jr, ref=1 fixed=1)
const uint8_t k067Old0[] = { 0x20, 0x4C };
const uint8_t k067New0[] = { 0x18, 0x4C };
const SgbcEdit k067[] = { { 0x00021F, 2, k067Old0, k067New0 } };
// Ohasuta Yama-chan & Raymond (Japan) (SGB Enhanced) (GB Compatible).zip  (force_jr, ref=1 fixed=1)
const uint8_t k068Old0[] = { 0x20, 0x09 };
const uint8_t k068New0[] = { 0x18, 0x09 };
const SgbcEdit k068[] = { { 0x010450, 2, k068Old0, k068New0 } };
// Phantom Zona (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k069Old0[] = { 0x28, 0x17 };
const uint8_t k069New0[] = { 0x00, 0x00 };
const SgbcEdit k069[] = { { 0x000180, 2, k069Old0, k069New0 } };
// Pocket Bomberman (USA, Europe) (SGB Enhanced) (GB Compatible).zip  (force_jr, ref=0 fixed=0)
const uint8_t k070Old0[] = { 0x20, 0x24 };
const uint8_t k070New0[] = { 0x18, 0x24 };
const SgbcEdit k070[] = { { 0x00024B, 2, k070Old0, k070New0 } };
...
const SgbcEdit k071[] = { { 0x009C59, 1, k071Old0, k071New0 } };
...
const SgbcEdit k072[] = { { 0x009C59, 1, k072Old0, k072New0 } };
...
const SgbcEdit k073[] = { { 0x009C59, 1, k073Old0, k073New0 } };
...
const SgbcEdit k076[] = { { 0x009CC3, 1, k076Old0, k076New0 } };
// Pokemon - Goldene Edition (Germany) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k077Old0[] = { 0xC0 };
const uint8_t k077New0[] = { 0x00 };
const SgbcEdit k077[] = { { 0x009CC3, 1, k077Old0, k077New0 } };
// Pokemon - Silberne Edition (Germany) (Beta) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k078Old0[] = { 0xC0 };
const uint8_t k078New0[] = { 0x00 };
const SgbcEdit k078[] = { { 0x009CC3, 1, k078Old0, k078New0 } };
// Pokemon - Silberne Edition (Germany) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k079Old0[] = { 0xC0 };
const uint8_t k079New0[] = { 0x00 };
const SgbcEdit k079[] = { { 0x009CC3, 1, k079Old0, k079New0 } };
// Pokemon - Silver Version (USA, Europe) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k080Old0[] = { 0xC0 };
const uint8_t k080New0[] = { 0x00 };
const SgbcEdit k080[] = { { 0x009CC3, 1, k080Old0, k080New0 } };
// Pokemon - Version Argent (France) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k081Old0[] = { 0xC0 };
const uint8_t k081New0[] = { 0x00 };
const SgbcEdit k081[] = { { 0x009CC3, 1, k081Old0, k081New0 } };
// Pokemon - Version Or (France) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k082Old0[] = { 0xC0 };
const uint8_t k082New0[] = { 0x00 };
const SgbcEdit k082[] = { { 0x009CC3, 1, k082Old0, k082New0 } };
// Pokemon - Versione Argento (Italy) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k083Old0[] = { 0xC0 };
const uint8_t k083New0[] = { 0x00 };
const SgbcEdit k083[] = { { 0x009CC3, 1, k083Old0, k083New0 } };
// Pokemon - Versione Oro (Italy) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k084Old0[] = { 0xC0 };
const uint8_t k084New0[] = { 0x00 };
const SgbcEdit k084[] = { { 0x009CC3, 1, k084Old0, k084New0 } };
// Pokemon Card GB (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch+imm_pre_fork, ref=1 fixed=0)
const uint8_t k085Old0[] = { 0x28, 0x0C };
const uint8_t k085New0[] = { 0x00, 0x00 };
const uint8_t k085Old1[] = { 0x06, 0x01 };
const uint8_t k085New1[] = { 0x06, 0x02 };
const SgbcEdit k085[] = { { 0x000337, 2, k085Old0, k085New0 }, { 0x000343, 2, k085Old1, k085New1 } };
// Pokemon Gold (Taiwan) (En) (Unl).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k086Old0[] = { 0xC0 };
const uint8_t k086New0[] = { 0x00 };
const SgbcEdit k086[] = { { 0x009C59, 1, k086Old0, k086New0 } };
...
const uint8_t k087Old0[] = { 0x28, 0x0C };
const uint8_t k087New0[] = { 0x00, 0x00 };
const uint8_t k087Old1[] = { 0x06, 0x00 };
const uint8_t k087New1[] = { 0x06, 0x02 };
const uint8_t k087Old2[] = { 0x06, 0x01 };
const uint8_t k087New2[] = { 0x06, 0x02 };
const SgbcEdit k087[] = { { 0x00033E, 2, k087Old0, k087New0 }, { 0x000343, 2, k087Old1, k087New1 }, { 0x00034A, 2, k087Old2, k087New2 } };
// Pokemon Trading Card Game (Europe) (En,Es,It) (SGB Enhanced) (GB Compatible).zip  (manual: detect, console stays CGB, ref=? fixed=0)
const uint8_t k088Old0[] = { 0x28, 0x0C };
const uint8_t k088New0[] = { 0x00, 0x00 };
const uint8_t k088Old1[] = { 0x06, 0x00 };
const uint8_t k088New1[] = { 0x06, 0x02 };
const uint8_t k088Old2[] = { 0x06, 0x01 };
const uint8_t k088New2[] = { 0x06, 0x02 };
const SgbcEdit k088[] = { { 0x00033E, 2, k088Old0, k088New0 }, { 0x000343, 2, k088Old1, k088New1 }, { 0x00034A, 2, k088Old2, k088New2 } };
...
const uint8_t k089Old0[] = { 0x28, 0x0C };
const uint8_t k089New0[] = { 0x00, 0x00 };
const uint8_t k089Old1[] = { 0x06, 0x00 };
const uint8_t k089New1[] = { 0x06, 0x02 };
const uint8_t k089Old2[] = { 0x06, 0x01 };
const uint8_t k089New2[] = { 0x06, 0x02 };
const SgbcEdit k089[] = { { 0x00033E, 2, k089Old0, k089New0 }, { 0x000343, 2, k089Old1, k089New1 }, { 0x00034A, 2, k089Old2, k089New2 } };
// Pokemon Trading Card Game (Europe) (En,Fr,De) (SGB Enhanced) (GB Compatible).zip  (manual: detect, console stays CGB, ref=? fixed=0)
const uint8_t k090Old0[] = { 0x28, 0x0C };
const uint8_t k090New0[] = { 0x00, 0x00 };
const uint8_t k090Old1[] = { 0x06, 0x00 };
const uint8_t k090New1[] = { 0x06, 0x02 };
const uint8_t k090Old2[] = { 0x06, 0x01 };
const uint8_t k090New2[] = { 0x06, 0x02 };
const SgbcEdit k090[] = { { 0x00033E, 2, k090Old0, k090New0 }, { 0x000343, 2, k090Old1, k090New1 }, { 0x00034A, 2, k090Old2, k090New2 } };
// Pokemon Trading Card Game (USA, Australia) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch+imm_pre_fork, ref=1 fixed=0)
const uint8_t k091Old0[] = { 0x28, 0x0C };
const uint8_t k091New0[] = { 0x00, 0x00 };
const uint8_t k091Old1[] = { 0x06, 0x01 };
const uint8_t k091New1[] = { 0x06, 0x02 };
const SgbcEdit k091[] = { { 0x00034D, 2, k091Old0, k091New0 }, { 0x000359, 2, k091Old1, k091New1 } };
// Puchi Carat (Europe) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k092Old0[] = { 0xCA, 0x23, 0x41 };
const uint8_t k092New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k092[] = { { 0x00404D, 3, k092Old0, k092New0 } };
// Puchi Carat (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k093Old0[] = { 0xCA, 0x23, 0x41 };
const uint8_t k093New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k093[] = { { 0x00404D, 3, k093Old0, k093New0 } };
// Puchi Carat (USA) (Proto 1) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k094Old0[] = { 0xCA, 0x23, 0x41 };
const uint8_t k094New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k094[] = { { 0x00404D, 3, k094Old0, k094New0 } };
// Puchi Carat (USA) (Proto 2) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k095Old0[] = { 0xCA, 0x23, 0x41 };
const uint8_t k095New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k095[] = { { 0x00404D, 3, k095Old0, k095New0 } };
// Quartet (World) (GB Compatible) (Aftermarket) (Unl).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k096Old0[] = { 0x20, 0x28 };
const uint8_t k096New0[] = { 0x00, 0x00 };
const SgbcEdit k096[] = { { 0x0044A1, 2, k096Old0, k096New0 } };
// Robopon - Star Version (USA) (Proto).zip  (nop_skip_branch, ref=1 fixed=0)
const uint8_t k097Old0[] = { 0x28, 0x2A };
const uint8_t k097New0[] = { 0x00, 0x00 };
const SgbcEdit k097[] = { { 0x063210, 2, k097Old0, k097New0 } };
// Robopon - Sun Version (USA) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=0)
const uint8_t k098Old0[] = { 0x28, 0x2A };
const uint8_t k098New0[] = { 0x00, 0x00 };
const SgbcEdit k098[] = { { 0x063210, 2, k098Old0, k098New0 } };
// Robot Poncots - Comic Bom Bom Special Version (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=0)
const uint8_t k099Old0[] = { 0x28, 0x2A };
const uint8_t k099New0[] = { 0x00, 0x00 };
const SgbcEdit k099[] = { { 0x063145, 2, k099Old0, k099New0 } };
// Robot Poncots - Moon Version (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=0)
const uint8_t k100Old0[] = { 0x28, 0x2A };
const uint8_t k100New0[] = { 0x00, 0x00 };
const SgbcEdit k100[] = { { 0x063145, 2, k100Old0, k100New0 } };
// Robot Poncots - Star Version (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=0)
const uint8_t k101Old0[] = { 0x28, 0x2A };
const uint8_t k101New0[] = { 0x00, 0x00 };
const SgbcEdit k101[] = { { 0x063143, 2, k101Old0, k101New0 } };
// Robot Poncots - Sun Version (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=0)
const uint8_t k102Old0[] = { 0x28, 0x2A };
const uint8_t k102New0[] = { 0x00, 0x00 };
const SgbcEdit k102[] = { { 0x063143, 2, k102Old0, k102New0 } };
...
const uint8_t k103Old0[] = { 0x28, 0x0C };
const uint8_t k103New0[] = { 0x00, 0x00 };
const SgbcEdit k103[] = { { 0x0001D7, 2, k103Old0, k103New0 } };
// Super Black Bass Pocket 3 (Japan) (SGB Enhanced) (GB Compatible).zip  (manual: both flag tests off, ref=? fixed=1)
const uint8_t k104Old0[] = { 0x20, 0x07 };
const uint8_t k104New0[] = { 0x00, 0x00 };
const uint8_t k104Old1[] = { 0x20, 0x03 };
const uint8_t k104New1[] = { 0x00, 0x00 };
const SgbcEdit k104[] = { { 0x0002DE, 2, k104Old0, k104New0 }, { 0x0002E2, 2, k104Old1, k104New1 } };
...
const uint8_t k105Old0[] = { 0xCB, 0x4E };
const uint8_t k105New0[] = { 0xAF, 0x00 };
const SgbcEdit k105[] = { { 0x000256, 2, k105Old0, k105New0 } };
// Taito Memorial - Bubble Bobble (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k106Old0[] = { 0xCA, 0x8D, 0x02 };
const uint8_t k106New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k106[] = { { 0x0001A6, 3, k106Old0, k106New0 } };
// Taito Memorial - Chase H.Q. - Secret Police (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k107Old0[] = { 0x28, 0x12 };
const uint8_t k107New0[] = { 0x00, 0x00 };
const SgbcEdit k107[] = { { 0x0001C0, 2, k107Old0, k107New0 } };
// TNN Outdoors Fishing Champ (USA) (SGB Enhanced) (GB Compatible).zip  (manual: both flag tests off, ref=? fixed=1)
const uint8_t k108Old0[] = { 0x20, 0x07 };
const uint8_t k108New0[] = { 0x00, 0x00 };
const uint8_t k108Old1[] = { 0x20, 0x03 };
const uint8_t k108New1[] = { 0x00, 0x00 };
const SgbcEdit k108[] = { { 0x0002DE, 2, k108Old0, k108New0 }, { 0x0002E2, 2, k108Old1, k108New1 } };
// Tsuri Sensei 2 (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k109Old0[] = { 0x28, 0x03 };
const uint8_t k109New0[] = { 0x00, 0x00 };
const SgbcEdit k109[] = { { 0x000220, 2, k109Old0, k109New0 } };
// Wario Land 2 (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k110Old0[] = { 0xC2, 0x55, 0x03 };
const uint8_t k110New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k110[] = { { 0x00025D, 3, k110Old0, k110New0 } };
// Wario Land II (USA, Europe) (SGB Enhanced) (GB Compatible).zip  (nop_skip_branch, ref=1 fixed=1)
const uint8_t k111Old0[] = { 0xC2, 0x55, 0x03 };
const uint8_t k111New0[] = { 0x00, 0x00, 0x00 };
const SgbcEdit k111[] = { { 0x00025D, 3, k111Old0, k111New0 } };
// Wetrix GB (Japan) (SGB Enhanced) (GB Compatible).zip  (force_jr, ref=1 fixed=1)
const uint8_t k112Old0[] = { 0x20, 0x03 };
const uint8_t k112New0[] = { 0x18, 0x03 };
const SgbcEdit k112[] = { { 0x000BA6, 2, k112Old0, k112New0 } };
// Zelda no Densetsu - Yume o Miru Shima DX (Japan) (Beta) (1998-11-09) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k113Old0[] = { 0xC0 };
const uint8_t k113New0[] = { 0x00 };
const SgbcEdit k113[] = { { 0x0F2A25, 1, k113Old0, k113New0 } };
// Zelda no Densetsu - Yume o Miru Shima DX (Japan) (Rev 2) (Beta) (1999-08-04) (SGB Enhanced).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k114Old0[] = { 0xC0 };
const uint8_t k114New0[] = { 0x00 };
const SgbcEdit k114[] = { { 0x0F2A25, 1, k114Old0, k114New0 } };
// Zelda no Densetsu - Yume o Miru Shima DX (Japan) (Rev 2) (Beta) (1999-09-04) (SGB Enhanced).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k115Old0[] = { 0xC0 };
const uint8_t k115New0[] = { 0x00 };
const SgbcEdit k115[] = { { 0x0F2A25, 1, k115Old0, k115New0 } };
// Zelda no Densetsu - Yume o Miru Shima DX (Japan) (Rev 2) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k116Old0[] = { 0xC0 };
const uint8_t k116New0[] = { 0x00 };
const SgbcEdit k116[] = { { 0x0F2A25, 1, k116Old0, k116New0 } };
// Zelda no Densetsu - Yume o Miru Shima DX (Japan) (SGB Enhanced) (GB Compatible).zip  (nop_early_ret, ref=1 fixed=1)
const uint8_t k117Old0[] = { 0xC0 };
const uint8_t k117New0[] = { 0x00 };
const SgbcEdit k117[] = { { 0x0F2A25, 1, k117Old0, k117New0 } };
...
const uint8_t k118Old0[] = { 0xC8 };
const uint8_t k118New0[] = { 0x00 };
const uint8_t k118Old1[] = { 0x28, 0x01 };
const uint8_t k118New1[] = { 0x18, 0x01 };
const SgbcEdit k118[] = { { 0x018010, 1, k118Old0, k118New0 }, { 0x018017, 2, k118Old1, k118New1 } };
...
const uint8_t k119Old0[] = { 0xC8 };
const uint8_t k119New0[] = { 0x00 };
const uint8_t k119Old1[] = { 0x28, 0x01 };
const uint8_t k119New1[] = { 0x18, 0x01 };
const SgbcEdit k119[] = { { 0x018010, 1, k119Old0, k119New0 }, { 0x018017, 2, k119Old1, k119New1 } };
...
const SgbcPatch kPatches[] = {
	...
	{ 0xFC46, "MONOPOLYGB", "DX Monopoly GB (Japan)", k027, 2 },
	{ 0x8B00, "PRO FISHINGAFCP\200", "EuroSport Pro Champ Fishing (Europe) (Proto)", k028, 2 },
	{ 0x8DB6, "FAIRY   KITTY", "Fairy Kitty no Kaiun Jiten - Yousei no Kuni no Uranai Shugyou (Japan) (Rev 1)", k029, 2 },
	{ 0xA958, "FAIRY   KITTY", "Fairy Kitty no Kaiun Jiten - Yousei no Kuni no Uranai Shugyou (Japan)", k030, 2 },
	{ 0x1689, "FIFA 2000", "FIFA 2000 (USA, Europe)", k031, 2 },
	{ 0x7652, "HAMSTAR PRADISE\200", "Hamster Paradise (Japan)", k032, 3 },
	{ 0x8980, "TENTEN", "Hanasaka Tenshi Tenten-kun no Beat Breaker (Japan)", k033, 1 },
	{ 0xE5F7, "H-MOON2 CGBBM2P\200", "Harvest Moon 2 GBC (Europe)", k034, 1 },
	{ 0xB3DC, "H-MOON2 CGBBM2D\200", "Harvest Moon 2 GBC (Germany)", k035, 1 },
	{ 0x271C, "H-MOON2 CGBBM2E\200", "Harvest Moon 2 GBC (USA)", k036, 1 },
	{ 0x6920, "MAHJONGOH", "Honkaku Yonin Uchi Mahjong - Mahjong Ou (Japan)", k037, 1 },
	{ 0xB3CA, "TRACK&FIELDAHDJ\200", "Hyper Olympic Series - Track & Field GB (Japan)", k038, 1 },
	{ 0xF4B2, "INTER RALLYARLE\200", "International Rally (USA)", k039, 2 },
	{ 0x9897, "TRACK&FIELDAHDP\200", "International Track & Field (Europe) (En,Fr,De,It)", k040, 1 },
	{ 0x9A3A, "TRACK&FIELDAHDE\200", "International Track & Field (USA)", k041, 1 },
	{ 0xB9F1, "ITS W_RALLYARLJ\200", "It's a World Rally (Japan)", k042, 1 },
	{ 0x7C1B, "JINSEI TOMOACJJ\200", "Jinsei Game - Tomodachi Takusan Tsukurou yo! (Japan)", k043, 1 },
	{ 0x5650, "MUSCLERANK2B6KJ\200", "Kinniku Banzuke GB 2 - Mezase! Muscle Champion (Japan)", k044, 1 },
	{ 0x2DB1, "KOUSHIEN POCKET\200", "Koushien Pocket (Japan)", k045, 1 },
	{ 0x7789, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (Europe) (Rev 2) (Beta) (1999-09-19)", k046, 1 },
	{ 0x5E40, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (France) (Rev 1) (Beta) (1999-09-04)", k047, 1 },
	{ 0x6046, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (France) (Rev 1) (Beta) (1999-09-22)", k048, 1 },
	{ 0x9836, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (France) (Rev 1)", k049, 1 },
	{ 0x1377, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (France)", k050, 1 },
	{ 0x2D7E, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (Germany) (Beta) (1998-12-11)", k051, 1 },
	{ 0x89E8, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (Germany) (Rev 1) (Beta) (1999-09-04)", k052, 1 },
	{ 0x8BEE, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (Germany) (Rev 1) (Beta) (1999-09-22)", k053, 1 },
	{ 0x8ACE, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (Germany) (Rev 1)", k054, 1 },
	{ 0x2D09, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (Germany)", k055, 1 },
	{ 0x2735, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (USA, Europe) (Rev 1)", k056, 1 },
	{ 0x0000, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (USA, Europe) (Rev 2) (Beta) (1999-08-19)", k057, 1 },
	{ 0x7507, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (USA, Europe) (Rev 2) (Beta) (1999-09-04)", k058, 1 },
	{ 0x7689, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (USA, Europe) (Rev 2) (Beta) (1999-09-07)", k059, 1 },
	{ 0x788F, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (USA, Europe) (Rev 2) (Beta) (1999-09-23)", k060, 1 },
	{ 0x0135, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (USA, Europe) (Rev 2)", k061, 1 },
	{ 0xE3FD, "ZELDA", "Legend of Zelda, The - Link's Awakening DX (USA, Europe)", k062, 1 },
	{ 0x259C, "LODOSS WAR GB", "Lodoss-tou Senki - Eiyuu Kishiden GB (Japan)", k063, 1 },
	{ 0xD6BB, "NUMBERPLACEARCJ\200", "Luca no Puzzle de Daibouken! (Japan)", k064, 3 },
	{ 0xBE50, "MAHJONGJOOHA56J\200", "Mahjong Joou (Japan)", k065, 2 },
	{ 0xD1EF, "MEN IN BLACK", "Men in Black - The Series (USA, Europe)", k066, 1 },
	{ 0xA0C5, "NHL 2000", "NHL 2000 (USA, Europe)", k067, 1 },
	{ 0x5C51, "OHASTA Y&R", "Ohasuta Yama-chan & Raymond (Japan)", k068, 1 },
	{ 0x99CA, "PHANTOMZONABKZJ\200", "Phantom Zona (Japan)", k069, 1 },
	{ 0x41CB, "POKEBOM USA", "Pocket Bomberman (USA, Europe)", k070, 1 },
	{ 0x1D34, "POKEMON_SLVAAXJ\200", "Pocket Monsters Gin (Japan) (Rev 1)", k071, 1 },
	{ 0x7691, "POKEMON_SLVAAXJ\200", "Pocket Monsters Gin (Japan)", k072, 1 },
	{ 0x8460, "POKEMON_GLDAAUJ\200", "Pocket Monsters Kin (Japan) (Rev 1)", k073, 1 },
	{ 0x9353, "POKEMON_GLDAAUS\200", "Pokemon - Edicion Oro (Spain)", k074, 1 },
	{ 0x064B, "POKEMON_SLVAAXS\200", "Pokemon - Edicion Plata (Spain)", k075, 1 },
	{ 0x682D, "POKEMON_GLDAAUE\200", "Pokemon - Gold Version (USA, Europe)", k076, 1 },
	{ 0xDC97, "POKEMON_GLDAAUD\200", "Pokemon - Goldene Edition (Germany)", k077, 1 },
	{ 0x6A0E, "POKEMON_SLVAAXD\200", "Pokemon - Silberne Edition (Germany) (Beta)", k078, 1 },
	{ 0xCD6E, "POKEMON_SLVAAXD\200", "Pokemon - Silberne Edition (Germany)", k079, 1 },
	{ 0x0DAE, "POKEMON_SLVAAXE\200", "Pokemon - Silver Version (USA, Europe)", k080, 1 },
	{ 0xFB8C, "POKEMON_SLVAAXF\200", "Pokemon - Version Argent (France)", k081, 1 },
	{ 0x6FC6, "POKEMON_GLDAAUF\200", "Pokemon - Version Or (France)", k082, 1 },
	{ 0x7350, "POKEMON_SLVAAXI\200", "Pokemon - Versione Argento (Italy)", k083, 1 },
	{ 0xCE0C, "POKEMON_GLDAAUI\200", "Pokemon - Versione Oro (Italy)", k084, 1 },
	{ 0xD526, "POKEMON CARD GB\200", "Pokemon Card GB (Japan)", k085, 2 },
	{ 0x365F, "POKEMON_GOLD_US\200", "Pokemon Gold (Taiwan) (En) (Unl)", k086, 1 },
	{ 0xB440, "POKECARD", "Pokemon Trading Card Game (Europe) (En,Es,It) (Rev 1)", k087, 3 },
	{ 0xC869, "POKECARD", "Pokemon Trading Card Game (Europe) (En,Es,It)", k088, 3 },
	{ 0x49CD, "POKECARD", "Pokemon Trading Card Game (Europe) (En,Fr,De) (Rev 1)", k089, 3 },
	{ 0x5E22, "POKECARD", "Pokemon Trading Card Game (Europe) (En,Fr,De)", k090, 3 },
	{ 0x26A6, "POKECARD", "Pokemon Trading Card Game (USA, Australia)", k091, 2 },
	{ 0x48E6, "PUCHI CARATAIQP\200", "Puchi Carat (Europe)", k092, 1 },
	{ 0xF6BD, "PUCHI CARATACUJ\200", "Puchi Carat (Japan)", k093, 1 },
	{ 0x7926, "PUCHI CARATAIQE\200", "Puchi Carat (USA) (Proto 1)", k094, 1 },
	{ 0x1CF8, "PUCHI CARATAIQE\200", "Puchi Carat (USA) (Proto 2)", k095, 1 },
	{ 0xDCBF, "QUARTET", "Quartet (World) (Aftermarket) (Unl)", k096, 1 },
	{ 0x9C19, "STAR", "Robopon - Star Version (USA) (Proto)", k097, 1 },
	{ 0xDA57, "SUN", "Robopon - Sun Version (USA)", k098, 1 },
	{ 0x4527, "ROBO BOM", "Robot Poncots - Comic Bom Bom Special Version (Japan)", k099, 1 },
	{ 0x9E0A, "ROBO MOON", "Robot Poncots - Moon Version (Japan)", k100, 1 },
	{ 0x0453, "ROBOPON STAR", "Robot Poncots - Star Version (Japan)", k101, 1 },
	{ 0xFD8C, "ROBOPON SUN", "Robot Poncots - Sun Version (Japan)", k102, 1 },
	{ 0x43D3, "SENKAIIBUNRBHSJ\200", "Senkai Ibunroku Juntei Taisen - TV Animation Senkaiden Houshin Engi Yori (Japan)", k103, 1 },
	{ 0xC16E, "BASS POCKET 3", "Super Black Bass Pocket 3 (Japan)", k104, 2 },
	{ 0xEEFE, "SYLVANIAN", "Sylvanian Families - Otogi no Kuni no Pendant (Japan)", k105, 1 },
	{ 0x1C2F, "BUBBOB", "Taito Memorial - Bubble Bobble (Japan)", k106, 1 },
	{ 0x46E9, "CHASE HQ", "Taito Memorial - Chase H.Q. - Secret Police (Japan)", k107, 1 },
	{ 0xDDE6, "TNN FISHINGAFCE\200", "TNN Outdoors Fishing Champ (USA)", k108, 2 },
	{ 0x9524, "TURISENSEI2AF2J\200", "Tsuri Sensei 2 (Japan)", k109, 1 },
	{ 0x968F, "CGBWARIOLAND2", "Wario Land 2 (Japan)", k110, 1 },
	{ 0x24C7, "CGBWARIOLAND2", "Wario Land II (USA, Europe)", k111, 1 },
	{ 0x439C, "WETRIX GB", "Wetrix GB (Japan)", k112, 1 },
	{ 0x9874, "ZELDA", "Zelda no Densetsu - Yume o Miru Shima DX (Japan) (Beta) (1998-11-09)", k113, 1 },
	{ 0xD553, "ZELDA", "Zelda no Densetsu - Yume o Miru Shima DX (Japan) (Rev 2) (Beta) (1999-08-04)", k114, 1 },
	{ 0x3115, "ZELDA", "Zelda no Densetsu - Yume o Miru Shima DX (Japan) (Rev 2) (Beta) (1999-09-04)", k115, 1 },
	{ 0x331B, "ZELDA", "Zelda no Densetsu - Yume o Miru Shima DX (Japan) (Rev 2)", k116, 1 },
	{ 0x9872, "ZELDA", "Zelda no Densetsu - Yume o Miru Shima DX (Japan)", k117, 1 },
	{ 0x2874, "ZOIDS GENOBBGZJ\200", "Zoids - Jashin Fukkatsu! Genobreaker Hen (Japan) (Rev 1)", k118, 2 },
	{ 0x3885, "ZOIDS GENOBBGZJ\200", "Zoids - Jashin Fukkatsu! Genobreaker Hen (Japan)", k119, 2 },
};
// GENERATED-END
