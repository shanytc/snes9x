...
struct SSettings
{
	...
	bool8	MSU1;
	bool8	VoiceKun;            // Voicer-kun audio CD attached (Sound > Voicer-kun)
	...
	uint8	GBLinkPlayerIndex;   // 1 or 2 (later: 3, 4), fixed for the process; players past the first get their own .sav and save states
	bool8	MouseMaster;
	...
	// them: SGB sessions and CGB output carry their own colors.
	uint32	GBPalette[3][4];
