...
Based on Snes9x by Gary Henderson and Jerremy Koot.\r\n\r\n\
...
#define APP_NAME TEXT("SuperSnes9x")
// possible global strings
#define SNES9X_INFO TEXT("SuperSnes9x: Information")
#define SNES9X_WARN TEXT("SuperSnes9x: WARNING!")
#define SNES9X_DXS TEXT("SuperSnes9x: DirectSound")
#define SNES9X_SNDQ TEXT("SuperSnes9x: Sound CPU Question")
#define SNES9X_NP_ERROR TEXT("SuperSnes9x: NetPlay Error")
...
#define INPUTCONFIG_LABEL_BLUE TEXT("Blue means already mapped. Pink conflicts with hotkey.\nRed is reserved by Windows. Escape clears bindings.\nPress multiple keys for multi-bind. Delete removes last.")
...
#define HOTKEYS_LABEL_1_3 TEXT("Reset speed:")
#define HOTKEYS_LABEL_1_4 TEXT("Pause:")
#define HOTKEYS_LABEL_1_5 TEXT("Fast-forward toggle:")
#define HOTKEYS_LABEL_1_6 TEXT("Fast forward:")
#define HOTKEYS_LABEL_1_7 TEXT("Rewind:")
...
#define HOTKEYS_LABEL_1_16 TEXT("Soft reset:")
...
#define HOTKEYS_NSS_GAME1 TEXT("Select Slot 1:")
#define HOTKEYS_NSS_GAME2 TEXT("Select Slot 2:")
#define HOTKEYS_NSS_GAME3 TEXT("Select Slot 3:")
#define HOTKEYS_NSS_MOUNT1 TEXT("Mount/Eject Slot 1:")
#define HOTKEYS_NSS_MOUNT2 TEXT("Mount/Eject Slot 2:")
#define HOTKEYS_NSS_MOUNT3 TEXT("Mount/Eject Slot 3:")
